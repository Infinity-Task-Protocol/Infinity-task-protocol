<template>
    <div class="container mt-10">
        <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-[30px]">
            <div v-for="item in datas" :key="item" class="group shadow-sm shadow-gray-200 dark:shadow-gray-700 p-6 rounded-md bg-white dark:bg-slate-900">
                ...
                <div class="mt-6">
                    <router-link :to="{name: 'job-detail-one', params: {id: item.id}}" class="text-lg hover:text-emerald-600 font-semibold transition-all duration-500">Web Designer / Developer</router-link>
                    <h6 class="text-base font-medium"><i class="uil uil-map-marker"></i> {{item.country}}</h6>
                </div>
