  ...
  [
    {
      ...
      onSelect: () => navigateTo("/account/dashboard"),
    },
  ],
  [
    {
  ...
  >
    ...
    >
      ...
      <div v-else class="flex items-center md:order-2 space-x-3">
        ...
        >
          <template #default>
            <button class="dropdown-toggle items-center" type="button">
              <span
              ...
              >
                <span
                  v-if="
                    session.user &&
                    session.user.avatar &&
                    session.user.avatar.length > 0
                  "
                >
                  <img
                    :src="blobToImageUrl(session.user.avatar[0] ?? null) as string"
