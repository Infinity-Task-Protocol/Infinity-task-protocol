...
async function handleSubmit() {
  ...
  await session.backend.enterCodeVerification(BigInt(form.value.code)).then(() => {
    console.log("Verificado corractamente")
  })
            ...
            <form class="text-start" @submit.prevent="handleSubmit">
              <div class="grid grid-cols-1 gap-4">
                ...
                <div>
                  ...
                  <input v-model="form.code" type="text" class="form-input mt-1 border" placeholder="code" />
                </div>


                <div class="pt-4">
                  <button @click="getVerificationCode" class="py-2 px-4 font-semibold text-white bg-emerald-600 rounded-md hover:bg-emerald-700 transition">
